...
def parse_args():
    ...
    parser.add_argument('--config', default=os.path.join(PROJECT_PATH, 'mmdetection/configs/smpl/pretrain.py'),help='train config file path')
    ...
    #     type=list,
    #     default= [1],
    #     help='which number of gpus to use '
    #          '(only applicable to non-distributed training)')
