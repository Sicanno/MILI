...
smpl = SMPL('/mnt/8T/lyk/projects/data/smpl')
...
eval_dataset_mapper = dict(
    ...
    full_h36m=dict(
        type='H36MDataset',
        ann_file='/mnt/8T/lyk/train_anno/' + 'h36m/'+'rcnn/val.pkl',
        img_prefix='/mnt/8T/lyk/' + 'human3.6m/',
        # **common_val_cfg
    ),
    mupo_ts=dict(
        type='CommonDataset',
    ...
    ultimatum=dict(
        type='CommonDataset',
        ann_file='/mnt/8T/lyk/data_test/Panoptic/processed/annotations/' + '160422_ultimatum1.pkl',
        img_prefix='/mnt/8T/lyk/data_test/Panoptic/processed/',
    ),
    haggling=dict(
        type='CommonDataset',
        ann_file='/mnt/8T/lyk/data_test/Panoptic/processed/annotations/' + '160422_haggling1.pkl',
        img_prefix='/mnt/8T/lyk/data_test/Panoptic/processed/',
    ),
    pizza=dict(
        type='CommonDataset',
        ann_file='/mnt/8T/lyk/data_test/Panoptic/processed/annotations/' + '160906_pizza1.pkl',
        img_prefix='/mnt/8T/lyk/data_test/Panoptic/processed/',
    ),
    mafia=dict(
        type='CommonDataset',
        ann_file='/mnt/8T/lyk/data_test/Panoptic/processed/annotations/' + '160422_mafia2.pkl',
        img_prefix='/mnt/8T/lyk/data_test/Panoptic/processed/',
    ),
    mupots=dict(
        type='CommonDataset',
...
def parse_args():
    ...
    parser.add_argument('--config', default='configs/smpl/tune.py',help='train config file path')
    parser.add_argument('--dataset', default='mafia',help='for which dataset will be evaluated')
    parser.add_argument('--work_dir', default='/mnt/8T/lyk/projects/compute/forth/',help='the dir to save logs and models')
    parser.add_argument(
        '--resume_from', default='/mnt/8T/lyk/projects/work_dirs/forth/branch2-small-coco/epoch_43.pth',help='the checkpoint file to resume from')
    parser.add_argument(
        '--validate',
        action='store_true',
