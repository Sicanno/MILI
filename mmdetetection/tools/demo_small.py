...
def parse_args():
    ...
    parser.add_argument('--image_folder', help='Path to folder with images',default='/mnt/8T/lyk/projects/demo_images/')
    # /mnt/8T/lyk/projects/playground/
    parser.add_argument('--output_folder', default='/mnt/8T/lyk/projects/final_result/forth/ablation_withbd/', help='Path to save results')
    parser.add_argument('--ckpt', type=str, default=
    # '/mnt/8T/lyk/projects/work_dirs/forth/branch2-small-all/epoch_23.pth'
    #'/mnt/8T/lyk/projects/work_dirs/forth/ab-no-up-small-coco/epoch_11.pth'
    '/mnt/8T/lyk/projects/work_dirs/forth/branch2-small-coco/epoch_1.pth'
    )
...
def main():
    ...
    with torch.no_grad():
        ...
        for image in images:
            ...
            ori_shape = img.shape
            dest_img, img_shape0, pad_shape0, scale_factor0 = img_transform(img, img_scale0)
            ...
            if pred_results is not None:
                ...
                # cv2.imwrite(f'{file_name.replace(folder_name, output_folder)}.output.jpg', img_viz)
